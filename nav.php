...
<nav id="navi">
  ...
  <ul class="MyContainer">
    ...
    <span onclick="location.href='dashboard.php';" class="glyphicon glyphicon-dashboard" aria-hidden="true"><c class="tooltiptext">Dashboard</c></span>
    <span onclick="location.href='descubrefinal.html';" class="glyphicon glyphicon-globe" aria-hidden="true"><c class="tooltiptext">Descubre</c></span>
   <span onclick="location.href='proyectos.php';" class="glyphicon glyphicon-plus" aria-hidden="true"><c class="tooltiptext">Crear Proyecto</c></span>
